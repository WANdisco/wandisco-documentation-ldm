...
Once you have [connected your metastores and databases](./connect-metastores.md), define the metadata rules that determine which metadata you want to migrate.
